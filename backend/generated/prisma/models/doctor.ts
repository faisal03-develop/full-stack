...
export type doctorWhereInput = {
  ...
  doc_id?: Prisma.StringFilter<"doctor"> | string
...
export type doctorScalarWhereWithAggregatesInput = {
  ...
  doc_id?: Prisma.StringWithAggregatesFilter<"doctor"> | string
...
export type doctorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"doc_id" | "name" | "username" | "password" | "email" | "createdAt", ExtArgs["result"]["doctor"]>
...
export interface doctorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const doctorWithDoc_idOnly = await prisma.doctor.findMany({ select: { doc_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Doctors and only return the `doc_id`
   * const doctorWithDoc_idOnly = await prisma.doctor.createManyAndReturn({
   *   select: { doc_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Doctors and only return the `doc_id`
   * const doctorWithDoc_idOnly = await prisma.doctor.updateManyAndReturn({
   *   select: { doc_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface doctorFieldRefs {
  readonly doc_id: Prisma.FieldRef<"doctor", 'String'>
